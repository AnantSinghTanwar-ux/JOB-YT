...
export const CreditModel = {
  ...
  async record(
    ...
    const { rows } = await client.query(
          `INSERT INTO credit_transactions (user_id, type, amount, status, balance_after, description, reference_id, credit_category, expiry_date)
